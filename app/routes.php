...
$router->get('/admin/clau/{token}', [AuthController::class, 'link']);
$router->get('/admin/clau', [AuthController::class, 'showPassword']);
$router->post('/admin/clau', [AuthController::class, 'savePassword']);
